...
export default function Landing() {
  ...
  const sendMail = () => {
    ...
    if (name.length && email.includes('@') && message.length > 2) {
      emailjs.send('service_cv92p54', 'lxzajri', templateParams)
  ...
  return ( <
    ...
    Marketing
    for USA, Northern Europe, UK, China, and other growing markets. < /p>​ <
    p > We take care of communication and public relations
    for the elite wineries of Italy and offer access to an extensive database of international experts in the vast field of wine culture and science. < /p> <
    br / >
    <
    ...
    p > Please < a href = '#contact'
    style = {
      {
        textDecoration: 'underline'
      }
    } > contact us < /a> for further informations.</p > ​
    <
    p > artwork by < a href = "https://www.carlitodalceggio.com"
    target = "_blank"
    style = {
      {
        textDecoration: 'underline'
      }
    } > Carlito Dalceggio < /a></p >
    <
    /div> < /
    div > <
    /main>
    ...
    Email: < a href = "mailto:g.gelasio@gmail.com"
    style = {
      {
        textDecoration: 'underline'
      }
    } > g.gelasio @gmail.com < /a> < /
    p > <
    ...
    onChange = {
      (event) => handleChangeMessage(event)
    }
    disabled = {
      submitted
    }
