              ...
              <form onSubmit={
                ...
                <div className="flex-auto p-5 lg:p-10" >
                  <h4 id='contact'
                    ...
                    Contact </h4> <p className="leading-relaxed mt-1 mb-4 text-blueGray-500 text-center">
                    Email: <a href="mailto:g.gelasio@gmail.com"
                      style={
                        {
                          textDecoration: 'underline'
                        }
                      } > g.gelasio @gmail.com </a> </p> <div className="relative w-full mb-3 mt-8" >
